        ...
        Expanded(child: 
          ListView(children: <Widget>[
            ...
            AnimatedCrossFade(
              ...
              })), secondChild: Column(children: List.generate(10, (i) {
                return  Padding(
                
                child: Card(shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(10)), child: Padding(padding: EdgeInsets.fromLTRB(10, 10, 15, 10), child: Row(children: <Widget>[
